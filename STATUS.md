...
updated: 2026-09-25
remaining:
  - "1.0.1 is not published until its reds are green (owner, 2026-09-25): the two lavish meals of feature 07 are green (request 63b1, 2/2, 2026-09-25, docs/runs/2026-09-25.md); the cooking pass 2b (request 20260925-145935-950-c4c3, last of the queue) is not. Fail fast skips the non-regression pass, not this validation; see TESTING.md, Before a publication."
  ...
  - "partial (done -> tested): passes 1 to 10 and feature 20 are green (in_game_runs above). Not green: pass 2b (cooking film, feature 09): four attempts, none a verdict on the mod, see docs/runs/2026-09-24.md and TESTING.md; request 20260925-145935-950-c4c3 queued. The final replay of passes 1, 2 and 5 on the normalized suite (no @wip, explicit filters, fixed fixture foodType) is the non-regression pass, after the publication under fail fast. Stage stays done until 2b is green."
