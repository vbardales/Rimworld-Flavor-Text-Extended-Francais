...
remaining:
  ...
  - "partial (done -> tested): passes 1 to 10 and feature 20 are green (in_game_runs above). Not green: pass 2b (cooking film, feature 09): four attempts, none a verdict on the mod, see docs/runs/2026-09-24.md and TESTING.md; request 20260925-153507-017-6072 queued. The final replay of passes 1, 2 and 5 on the normalized suite (no @wip, explicit filters, fixed fixture foodType) is the non-regression pass, after the publication under fail fast. Stage stays done until 2b is green."
