...
remaining:
  ...
  - "unverified (done -> tested): F13 is relevant. Its Pickle scenario is ready but awaits a committed fixture saved before this translation was installed and containing stored meals; it will pause on the existing meal's info card and produce the sole required review capture."
