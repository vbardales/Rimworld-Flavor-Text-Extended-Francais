...
remaining:
  ...
  - "unverified (done -> tested): the scenarios no Pickle scenario replaces: an exact dish, side-dish variety, DLC-less runs, an existing save with old meals, RIMMSQOL revealing the shortcut. Owner: user."
