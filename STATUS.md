...
mod_visibility: GitHub public; Workshop item 3806100488 private (owner, 2026-09-25)
detached: yes
stage: done
...
updated: 2026-09-25
remaining:
  - "1.0.1 is not published until its reds are green (owner, 2026-09-25): the two lavish meals of feature 07 are green (request 63b1, 2/2, 2026-09-25, docs/runs/2026-09-25.md); the cooking pass 2b is green too (request 20260925-153507-017-6072, 1/1, 200 s, 2026-09-25). No red scenario is left. Fail fast skips the non-regression pass, not this validation; see TESTING.md, Before a publication."
  - "1.0.1 content prepared (owner, 2026-09-25): the new description and Preview go out with it (update_description and update_preview on, same options in the dry-run and the publish). Done in the repository: new description (Workshop links on every mod name, thanks to the test tools and to the authors of the optional mods whose tables are covered and of RIMMSQOL, AI tools named: Claude, Codex, Claude Code, OpenAI image tool), About.xml links Flavor Text Extended's Workshop page, Preview regenerated (Extended as a suffix), gallery in Art/Gallery (01 and 03 from the 1.0.1 run), workflow regenerated with --gallery-dir Art/Gallery, French description block prepared for the manual page. The authors of [RH2] Faction: V.O.I.D. (2883208829), Medieval Overhaul (3219596926) and Optimization: Meats - C# Edition (2542931556) are thanked too (ids checked on the Workshop pages, owner 2026-09-25). Still open: the final SHA, a dry-run with both options and the owner's approval."
  ...
  - "partial (done -> tested): passes 1 to 10 and feature 20 are green (in_game_runs above). Pass 2b (cooking film, feature 09) is green since 2026-09-25 (request 20260925-153507-017-6072, 1/1); four earlier attempts were none a verdict on the mod, see docs/runs/2026-09-24.md and TESTING.md. The final replay of passes 1, 2 and 5 on the normalized suite (no @wip, explicit filters, fixed fixture foodType) is the non-regression pass, after the publication under fail fast. Stage stays done until the non-regression replay is played."
