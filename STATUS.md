...
remaining:
  ...
  - "not_applicable (done -> tested): F13, compatibility with meals saved before this translation was installed, was explicitly removed from the audit scope. No fixture or hand-played substitute is required."
  ...
  - "superseded 2026-09-22: F13 (an existing save with old meals) was explicitly removed from scope. Exact dish/side-dish variety and RIMMSQOL's own checkbox are addressed by Pickle-produced captures; no hand-played replacement is requested. The language switch is not a gap: the game restarts on a language change, so the English and French passes cover it."
