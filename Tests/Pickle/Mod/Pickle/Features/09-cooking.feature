...
# deliverable: a person watches the cook, then reads the cooked meal's info card, opened by the last steps and captured, and judges the French.
#
...
Feature: a colonist cooks a meal that Flavor Text names, filmed
  ...
  Scenario: a colonist cooks at a fuelled stove, and the meal is named in the language of the pass
    ...
    And I open the info card of the cooked meal
    And Nelim's Pickle Tools: screenshot mode is enabled around the open windows
    And I take a screenshot "cooked meal, info card"
