...
Add-Type -Path @((Join-Path $root 'Source/FrenchLanguage.cs'),(Join-Path $root 'Source/FrenchFallback.cs'),(Join-Path $root 'Source/RuntimePatches.cs'),(Join-Path $PSScriptRoot 'Tests/FallbackPrefix.cs'))
