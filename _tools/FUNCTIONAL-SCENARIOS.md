...
| F13 | Pickle loads a committed save made before this translation was installed, pauses on an already stored meal, opens its info card and captures it in ScreenshotMode. | Save loads without attributable errors. The existing meal remains usable and has a readable full name and description. Review only the resulting capture; do not hand-play a substitute. |
...
new-game coverage. F13 requires its committed pre-translation fixture and Pickle capture. F14 must not expose unresolved localization defects
