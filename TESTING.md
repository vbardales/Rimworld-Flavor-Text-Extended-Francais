...
| 2 | `sans-facultatifs`, French | The same set plus ScreenshotMode | French | 03, then 01, 04, 05, 06, 19, 07: seven launches under one lock | **played 2026-09-21 before the screenshot-mode revision.** The French fix pass remains useful history, but the revised clean captures require replay. |
